<script>
	...
	import BasicDatagrid from './headless/examples/_components/datagrids/basic/basic-datagrid.svelte';
	import PaginationDatagrid from './headless/examples/_components/datagrids/pagination/pagination-datagrid.svelte';
</script>
...
<section class="pb-12 lg:py-24">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="mb-14 text-center">
			...
			<p class="mx-auto max-w-md text-lg font-normal text-secondary-foreground md:max-w-2xl">
...
<!-- <ShowcaseDatagrid /> -->
<PaginationDatagrid data={{inventory: inventoryData}}/>
...
<section class="body-font">
	<div class="container mx-auto flex flex-wrap items-center px-5 py-12 lg:py-24">
		...
		>
			<h1 class="title-font mb-2 text-2xl font-medium sm:text-3xl">Displaying data made easy</h1>
			...
			<a class="mt-4 inline-flex items-center text-orange-500" href={hrefs.about}>
				Learn More
				<svg
					fill="none"
					stroke="currentColor"
		...
		<!-- <div class="flex flex-col md:w-1/2 md:pl-12">
			...
			<nav class="-mb-1 flex list-none flex-wrap">
				<li class="mb-1 w-1/2 lg:w-1/3">
					<a class="" href={hrefs.about}>About</a>
				</li>
				<li class="mb-1 w-1/2 lg:w-1/3">
