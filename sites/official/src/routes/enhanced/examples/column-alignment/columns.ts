...
export const columns = [
    accessorColumn({ accessorKey: 'id', align: "right" }),
    accessorColumn({ accessorKey: 'name', align: 'left' }),
    accessorColumn({ accessorKey: 'category', align: 'center' }),
    accessorColumn({ accessorKey: 'price', _meta: { grow: true }, align: 'right' }),
